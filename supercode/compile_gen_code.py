...
model_name = "codegemma-7b-it" # "CodeLlama-7b-Instruct-hf" # "Qwen3-4B" # "Qwen3-Coder-Next" # "Qwen2.5-Coder-3B-Instruct" # "Qwen2.5-Coder-3B-Instruct+Qwen3-4B" #
...
for file_name in [base_file_name, bench_file_name]:
    ...
    for i, sample in enumerate(samples):
        ...
        function = extract_code(sample["completion"])
